...
search_terms = ['logo chaîne française M6', 'logo ABC', 'logo XYZ', 'logo chaîne française tf1', 'logo chaîne française tfx', 'logo chaîne française c8', 'logo chaîne française france 2', 'logo chaîne française nrj12']
