...
pub_images = load_and_resize_images_from_folder("logo-tv")
nopub_images = load_and_resize_images_from_folder("pas-logo-tv")
...
model_checkpoint = ModelCheckpoint('test_3.keras', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
