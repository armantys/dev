...
def train_model():
    ...
    model_checkpoint = ModelCheckpoint('test_5.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
    ...
    model_cnn.fit(X_train, y_train, epochs=100, validation_data=(X_test, y_test), callbacks=[model_checkpoint, early_stopping])
